...
class Algorithm():
    def __init__(self, opt):
        ...
        self.opt = opt
        print('init_all_networks()')
        self.init_all_networks()
        print('init_all_criterions()')
    ...
    def load_pretrained(self, network, pretrained_path):
        ...
        if 'network' in pretrained_model:
            _network_key = 'network'
        else:
            _network_key = 'model_state_dict'
            
        if pretrained_model[_network_key].keys() == network.state_dict().keys():
            network.load_state_dict(pretrained_model[_network_key])
        else:
